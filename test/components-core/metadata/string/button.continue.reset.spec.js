...
const dataObject = require('~/components-core/metadata/string/button.continue.reset.json')
...
describe('~/components-core/metadata/string/button.continue.reset.json', () => {
