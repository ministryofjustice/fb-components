...
const dataObject = require('~/components-core/metadata/string/continue.page.summary.json')
...
describe('~/components-core/metadata/string/continue.page.summary.json', () => {
