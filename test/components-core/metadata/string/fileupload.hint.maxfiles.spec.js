...
const dataObject = require('~/components-core/metadata/string/fileupload.hint.maxfiles.json')
...
describe('~/components-core/metadata/string/fileupload.hint.maxfiles.json', () => {
