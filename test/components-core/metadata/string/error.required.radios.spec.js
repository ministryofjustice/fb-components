...
const dataObject = require('~/components-core/metadata/string/error.required.radios.json')
...
describe('~/components-core/metadata/string/error.required.radios.json', () => {
