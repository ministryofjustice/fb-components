...
const dataObject = require('~/components-core/metadata/string/error.date.missing.day.month.json')
...
describe('~/components-core/metadata/string/error.date.missing.day.month.json', () => {
