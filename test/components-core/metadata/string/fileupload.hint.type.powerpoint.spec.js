...
const dataObject = require('~/components-core/metadata/string/fileupload.hint.type.powerpoint.json')
...
describe('~/components-core/metadata/string/fileupload.hint.type.powerpoint.json', () => {
