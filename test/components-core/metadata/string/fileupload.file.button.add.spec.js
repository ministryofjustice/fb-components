...
const dataObject = require('~/components-core/metadata/string/fileupload.file.button.add.json')
...
describe('~/components-core/metadata/string/fileupload.file.button.add.json', () => {
