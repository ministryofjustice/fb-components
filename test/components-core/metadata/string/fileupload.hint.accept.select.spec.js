...
const dataObject = require('~/components-core/metadata/string/fileupload.hint.accept.select.json')
...
describe('~/components-core/metadata/string/fileupload.hint.accept.select.json', () => {
