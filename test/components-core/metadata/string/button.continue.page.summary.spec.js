...
const dataObject = require('~/components-core/metadata/string/button.continue.page.summary.json')
...
describe('~/components-core/metadata/string/button.continue.page.summary.json', () => {
