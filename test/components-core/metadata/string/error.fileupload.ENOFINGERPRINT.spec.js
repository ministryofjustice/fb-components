...
const dataObject = require('~/components-core/metadata/string/error.fileupload.ENOFINGERPRINT.json')
...
describe('~/components-core/metadata/string/error.fileupload.ENOFINGERPRINT.json', () => {
