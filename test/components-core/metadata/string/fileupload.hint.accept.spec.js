...
const dataObject = require('~/components-core/metadata/string/fileupload.hint.accept.json')
...
describe('~/components-core/metadata/string/fileupload.hint.accept.json', () => {
