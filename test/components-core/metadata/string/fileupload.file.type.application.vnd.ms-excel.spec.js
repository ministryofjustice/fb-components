...
const dataObject = require('~/components-core/metadata/string/fileupload.file.type.application.vnd.ms-excel.json')
...
describe('~/components-core/metadata/string/fileupload.file.type.application.vnd.ms-excel.json', () => {
