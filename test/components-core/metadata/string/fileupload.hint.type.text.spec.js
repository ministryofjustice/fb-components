...
const dataObject = require('~/components-core/metadata/string/fileupload.hint.type.text.json')
...
describe('~/components-core/metadata/string/fileupload.hint.type.text.json', () => {
