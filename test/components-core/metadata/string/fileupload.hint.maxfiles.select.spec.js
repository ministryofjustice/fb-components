...
const dataObject = require('~/components-core/metadata/string/fileupload.hint.maxfiles.select.json')
...
describe('~/components-core/metadata/string/fileupload.hint.maxfiles.select.json', () => {
