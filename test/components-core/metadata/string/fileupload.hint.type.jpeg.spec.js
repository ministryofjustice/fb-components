...
const dataObject = require('~/components-core/metadata/string/fileupload.hint.type.jpeg.json')
...
describe('~/components-core/metadata/string/fileupload.hint.type.jpeg.json', () => {
