...
const dataObject = require('~/components-core/metadata/string/error.maxSize.fileupload.json')
...
describe('~/components-core/metadata/string/error.maxSize.fileupload.json', () => {
