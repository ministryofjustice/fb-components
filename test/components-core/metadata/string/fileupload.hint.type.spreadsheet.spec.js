...
const dataObject = require('~/components-core/metadata/string/fileupload.hint.type.spreadsheet.json')
...
describe('~/components-core/metadata/string/fileupload.hint.type.spreadsheet.json', () => {
