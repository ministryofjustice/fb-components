...
const dataObject = require('~/components-core/metadata/string/error.date.missing.day.year.json')
...
describe('~/components-core/metadata/string/error.date.missing.day.year.json', () => {
