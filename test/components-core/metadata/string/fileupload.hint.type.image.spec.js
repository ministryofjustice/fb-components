...
const dataObject = require('~/components-core/metadata/string/fileupload.hint.type.image.json')
...
describe('~/components-core/metadata/string/fileupload.hint.type.image.json', () => {
