...
const dataObject = require('~/components-core/metadata/string/fileupload.file.button.remove.json')
...
describe('~/components-core/metadata/string/fileupload.file.button.remove.json', () => {
