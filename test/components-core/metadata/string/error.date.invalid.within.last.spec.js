...
const dataObject = require('~/components-core/metadata/string/error.date.invalid.within.last.json')
...
describe('~/components-core/metadata/string/error.date.invalid.within.last.json', () => {
