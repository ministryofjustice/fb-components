...
const dataObject = require('~/components-core/metadata/string/error.exclusiveMinimum.json')
...
describe('~/components-core/metadata/string/error.exclusiveMinimum.json', () => {
