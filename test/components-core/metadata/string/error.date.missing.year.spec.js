...
const dataObject = require('~/components-core/metadata/string/error.date.missing.year.json')
...
describe('~/components-core/metadata/string/error.date.missing.year.json', () => {
