...
const dataObject = require('~/components-core/metadata/string/fileupload.slot.button.remove.json')
...
describe('~/components-core/metadata/string/fileupload.slot.button.remove.json', () => {
