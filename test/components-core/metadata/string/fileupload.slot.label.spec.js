...
const dataObject = require('~/components-core/metadata/string/fileupload.slot.label.json')
...
describe('~/components-core/metadata/string/fileupload.slot.label.json', () => {
