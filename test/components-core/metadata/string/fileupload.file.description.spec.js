...
const dataObject = require('~/components-core/metadata/string/fileupload.file.description.json')
...
describe('~/components-core/metadata/string/fileupload.file.description.json', () => {
