...
const dataObject = require('~/components-core/metadata/string/error.date.missing.day.json')
...
describe('~/components-core/metadata/string/error.date.missing.day.json', () => {
