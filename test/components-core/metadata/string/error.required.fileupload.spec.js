...
const dataObject = require('~/components-core/metadata/string/error.required.fileupload.json')
...
describe('~/components-core/metadata/string/error.required.fileupload.json', () => {
