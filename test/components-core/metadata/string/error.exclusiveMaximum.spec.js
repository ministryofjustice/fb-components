...
const dataObject = require('~/components-core/metadata/string/error.exclusiveMaximum.json')
...
describe('~/components-core/metadata/string/error.exclusiveMaximum.json', () => {
