...
const dataObject = require('~/components-core/metadata/string/fileupload.hint.timing.json')
...
describe('~/components-core/metadata/string/fileupload.hint.timing.json', () => {
