...
const dataObject = require('~/components-core/metadata/string/error.maxSize.fileupload.multiple.json')
...
describe('~/components-core/metadata/string/error.maxSize.fileupload.multiple.json', () => {
