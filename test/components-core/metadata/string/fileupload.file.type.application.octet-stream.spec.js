...
const dataObject = require('~/components-core/metadata/string/fileupload.file.type.application.octet-stream.json')
...
describe('~/components-core/metadata/string/fileupload.file.type.application.octet-stream.json', () => {
