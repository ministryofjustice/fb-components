...
const dataObject = require('~/components-core/metadata/string/error.fileupload.accept.json')
...
describe('~/components-core/metadata/string/error.fileupload.accept.json', () => {
