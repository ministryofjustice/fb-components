...
const dataObject = require('~/components-core/metadata/string/error.date.invalid.after.json')
...
describe('~/components-core/metadata/string/error.date.invalid.after.json', () => {
