...
const dataObject = require('~/components-core/metadata/string/error.date.invalid.within.next.json')
...
describe('~/components-core/metadata/string/error.date.invalid.within.next.json', () => {
