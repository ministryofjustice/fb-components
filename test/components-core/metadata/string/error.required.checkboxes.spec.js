...
const dataObject = require('~/components-core/metadata/string/error.required.checkboxes.json')
...
describe('~/components-core/metadata/string/error.required.checkboxes.json', () => {
