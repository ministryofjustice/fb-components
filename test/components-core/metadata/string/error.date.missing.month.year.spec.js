...
const dataObject = require('~/components-core/metadata/string/error.date.missing.month.year.json')
...
describe('~/components-core/metadata/string/error.date.missing.month.year.json', () => {
