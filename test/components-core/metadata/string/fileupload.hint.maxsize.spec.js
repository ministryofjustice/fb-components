...
const dataObject = require('~/components-core/metadata/string/fileupload.hint.maxsize.json')
...
describe('~/components-core/metadata/string/fileupload.hint.maxsize.json', () => {
