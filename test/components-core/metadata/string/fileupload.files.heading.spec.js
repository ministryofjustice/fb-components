...
const dataObject = require('~/components-core/metadata/string/fileupload.files.heading.json')
...
describe('~/components-core/metadata/string/fileupload.files.heading.json', () => {
