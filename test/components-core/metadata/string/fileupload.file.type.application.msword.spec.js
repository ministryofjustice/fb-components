...
const dataObject = require('~/components-core/metadata/string/fileupload.file.type.application.msword.json')
...
describe('~/components-core/metadata/string/fileupload.file.type.application.msword.json', () => {
