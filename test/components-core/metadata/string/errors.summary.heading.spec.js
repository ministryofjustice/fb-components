...
const dataObject = require('~/components-core/metadata/string/errors.summary.heading.json')
...
describe('~/components-core/metadata/string/errors.summary.heading.json', () => {
