...
const dataObject = require('~/components-core/metadata/string/fileupload.hint.maxsize.select.json')
...
describe('~/components-core/metadata/string/fileupload.hint.maxsize.select.json', () => {
