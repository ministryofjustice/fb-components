...
const dataObject = require('~/components-core/metadata/string/cookies.message.value.json')
...
describe('~/components-core/metadata/string/cookies.message.value.json', () => {
