...
const dataObject = require('~/components-core/metadata/string/error.date.invalid.before.json')
...
describe('~/components-core/metadata/string/error.date.invalid.before.json', () => {
