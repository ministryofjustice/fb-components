...
const dataObject = require('~/components-core/metadata/string/error.fileupload.invalid.too-large.multiple.json')
...
describe('~/components-core/metadata/string/error.fileupload.invalid.too-large.multiple.json', () => {
