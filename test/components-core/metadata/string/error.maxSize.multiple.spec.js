...
const dataObject = require('~/components-core/metadata/string/error.maxSize.multiple.json')
...
describe('~/components-core/metadata/string/error.maxSize.multiple.json', () => {
