...
const dataObject = require('~/components-core/metadata/string/button.continue.page.start.classes.json')
...
describe('~/components-core/metadata/string/button.continue.page.start.classes.json', () => {
