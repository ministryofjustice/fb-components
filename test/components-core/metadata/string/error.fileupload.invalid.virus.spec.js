...
const dataObject = require('~/components-core/metadata/string/error.fileupload.invalid.virus.json')
...
describe('~/components-core/metadata/string/error.fileupload.invalid.virus.json', () => {
