...
const dataObject = require('~/test/components-core/specifications/string/error/string.error.json')
...
describe('~/components-core/specifications/string/error/string.error.schema.json', () => {
