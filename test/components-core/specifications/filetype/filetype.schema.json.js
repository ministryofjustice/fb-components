...
const dataObject = require('~/test/components-core/specifications/filetype/filetype.json')
...
describe('~/components-core/specifications/filetype/filetype.schema.json', () => {
