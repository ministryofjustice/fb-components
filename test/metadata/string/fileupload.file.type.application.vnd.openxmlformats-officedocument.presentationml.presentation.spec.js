...
describe('~/metadata/string/fileupload.file.type.application.vnd.openxmlformats-officedocument.presentationml.presentation.json', () => it('validates', () => expect(validator(dataObject)).to.be.true))
