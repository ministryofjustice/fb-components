...
describe('~/metadata/string/fileupload.file.type.application.vnd.ms-word.template.macroEnabled.12.json', () => it('validates', () => expect(validator(dataObject)).to.be.true))
