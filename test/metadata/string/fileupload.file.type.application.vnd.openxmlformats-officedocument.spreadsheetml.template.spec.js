...
describe('~/metadata/string/fileupload.file.type.application.vnd.openxmlformats-officedocument.spreadsheetml.template.json', () => it('validates', () => expect(validator(dataObject)).to.be.true))
