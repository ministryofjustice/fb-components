...
describe('~/metadata/string/fileupload.file.type.application.vnd.ms-powerpoint.slideshow.macroEnabled.12.json', () => it('validates', () => expect(validator(dataObject)).to.be.true))
